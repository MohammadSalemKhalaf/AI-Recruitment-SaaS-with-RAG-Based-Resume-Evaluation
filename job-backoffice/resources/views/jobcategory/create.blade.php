            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Enter the job category information below
                    </p>
                </div>

                {{-- Form --}}
                <form action="{{ route('job-categories.store') }}" method="POST" class="p-6">
                    @csrf
            ...
            <div class="mt-4 bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div class="flex items-start">
                    ...
                    <p class="text-sm text-blue-800">
                        <span class="font-medium">Examples:</span> Technology, Healthcare, Finance, Education, Retail, Construction
                    </p>
                </div>
            </div>
